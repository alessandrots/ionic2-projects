...
export class Discente {
    constructor(
        public idDiscente: number,
        public nomeDiscente: string,
        public nomeSituacaoDiscente: string
    ) { }
}

export class DetalheDiscente {
    constructor(
        public idDiscente: number,
        public nomeDiscente: string,
        ...
        public nomeOrientador: string,
        public nomeCategoriaOrientador: string,
        public dataInicioOrientacao: number,
        public dataFimOrientacao: number,
        public principal: boolean
    ) { }
}

export class DiscentePorProjeto {
    constructor(
        public id: number,
        public nome: string,
        public email: string,
...
let detalheDiscente = [{
    ...
    "abreviaturas": "CUNHA, A. S. R.",//["CUNHA, A. S. R."],
...
export function getDiscentes(params = <any>{}): Discente[] {
    return discentes;
}

export function getDiscentesPorGrauAcademico(params = <any>{}): Discente[] {
    let grau = params.grauAcademico;
    let mestrados;

    if (grau) {
        mestrados = discentes.filter((v) => {
...
export function getDetalheDiscente(params = <any>{}): DetalheDiscente {
    return detalheDiscente[0];
}

export function getResumoEntradaDiscentes(params = <any>{}): ResumoDiscente[] {
    return resumoEntradaDiscentes;
}

export function getResumoSaidaDiscentes(params = <any>{}): ResumoDiscente[] {
    return resumoSaidaDiscentes;
}

export function getDiscentesPorProjeto(params = <any>{}): DiscentePorProjeto[] {
